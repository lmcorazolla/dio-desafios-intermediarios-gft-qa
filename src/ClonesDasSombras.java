 ...
 * Desafio
 *
 * Uma das técnicas mais poderosas usadas pelos ninjas,
 * chamada de Kage Bunshin no Jutsu e conhecida também como "Técnica dos clones de sombra",
 ...
 *
 * E por se tratar de uma cópia fidedigna, essa cópia por si só
 * também é capaz de realizar a técnica de clone de sombra e, portanto,
 ...
 * É garantido que o valor de N é tal que é possível obter exatamente N
 * cópias de um ninja utilizando a técnica (incluindo o original).
 *
 * Saída
...
public class ClonesDasSombras {
    public static void main(String[] args) {
        Scanner leitor = new Scanner(System.in);
        int ninjas = 1;

        while (ninjas >= 1 && ninjas <= 106 && leitor.hasNext()) {
            ninjas = leitor.nextInt();
            int vezes = Integer.numberOfTrailingZeros(ninjas);
